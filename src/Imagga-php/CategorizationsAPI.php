...
class CategorizationsAPI {
	 ...
	 *
	 * @param string  $categorizerId: Categorizer ID (required)
	 * @param string  $url:           url (optional)
	 * @param string  $content:       Content id received by uploading an image to the content endpoint (optional)
	 * @return CategorizationResponse
	 */
	public function categorize($categorizerId, $url=null, $content=null) {

		//parse inputs
		$resourcePath = "/categorizations/{categorizer_id}";
		...
		if ($categorizerId != null) {
			$resourcePath = str_replace("{" . "categorizer_id" . "}",
				$this->apiClient->toPathValue($categorizerId), $resourcePath);
		}
		//make the API Call
		if (! isset($body)) {
			$body = null;
